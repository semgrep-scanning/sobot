...
/* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/zxing/aztec/detector/Detector.class */
public final class Detector {
    private static final int[] EXPECTED_CORNER_BITS = {3808, LiveProtos.Event.LIVE_DOWN_SETTINGS_CLICK_VALUE, TXLiveConstants.PLAY_WARNING_VIDEO_DISCONTINUITY, 1799};
    ...
    /* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/zxing/aztec/detector/Detector$Point.class */
    public static final class Point {
        ...
        public String toString() {
            return SimpleComparison.LESS_THAN_OPERATION + this.x + ' ' + this.y + '>';
        }
    }
    ...
    private static ResultPoint[] expandSquare(ResultPoint[] resultPointArr, int i, int i2) {
        ...
        float f2 = (x - x2) * f;
        float f3 = (y - y2) * f;
        ResultPoint resultPoint = new ResultPoint(x3 + f2, y3 + f3);
        ResultPoint resultPoint2 = new ResultPoint(x3 - f2, y3 - f3);
        ...
        float f4 = (x4 - x5) * f;
        float f5 = f * (y4 - y5);
        return new ResultPoint[]{resultPoint, new ResultPoint(x6 + f4, y6 + f5), resultPoint2, new ResultPoint(x6 - f4, y6 - f5)};
    }
