...
/* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/zxing/datamatrix/encoder/ErrorCorrection.class */
        ...
        while (true) {
            ...
            while (i10 > 0) {
                if (charAt == 0 || iArr2[i10] == 0) {
                    ...
                    int[] iArr3 = ALOG;
                    int[] iArr4 = LOG;
                    cArr[i10] = (char) (c2 ^ iArr3[(iArr4[charAt] + iArr4[iArr2[i10]]) % 255]);
                }
                i10--;
            }
