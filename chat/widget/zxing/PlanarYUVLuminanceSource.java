...
/* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/zxing/PlanarYUVLuminanceSource.class */
    ...
    */
    public byte[] getRow(int r7, byte[] r8) {
        ...
        L4d:
            ...
            r8 = r0
            r0 = r8
            java.lang.String r1 = "Requested row is outside the image: "
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sobot.chat.widget.zxing.PlanarYUVLuminanceSource.getRow(int, byte[]):byte[]");
    }
    ...
    public int[] renderThumbnail() {
        ...
        while (true) {
            ...
            while (true) {
                int i5 = i4;
                if (i5 < width) {
                    iArr[(i3 * width) + i5] = ((bArr[(i5 * 2) + i] & 255) * 65793) | (-16777216);
                    i4 = i5 + 1;
                }
            }
            i += this.dataWidth * 2;
