...
/* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/zxing/qrcode/decoder/Version.class */
public final class Version {
    ...
    /* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/zxing/qrcode/decoder/Version$ECB.class */
    ...
    /* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/zxing/qrcode/decoder/Version$ECBlocks.class */
    ...
    public BitMatrix buildFunctionPattern() {
        ...
        while (true) {
            ...
            int i4 = this.alignmentPatternCenters[i3];
            int i5 = 0;
            while (true) {
                int i6 = i5;
                if (i6 < length) {
                    if ((i3 != 0 || (i6 != 0 && i6 != length - 1)) && (i3 != length - 1 || i6 != 0)) {
                        bitMatrix.setRegion(this.alignmentPatternCenters[i6] - 2, i4 - 2, 5, 5);
                    }
                    i5 = i6 + 1;
                }
            }
        ...
        bitMatrix.setRegion(6, 9, 1, i7);
        bitMatrix.setRegion(9, 6, i7, 1);
