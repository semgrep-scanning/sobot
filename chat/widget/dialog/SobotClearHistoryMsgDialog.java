...
/* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/dialog/SobotClearHistoryMsgDialog.class */
public class SobotClearHistoryMsgDialog extends Dialog {
    ...
    public SobotClearHistoryMsgDialog(Activity activity, View.OnClickListener onClickListener) {
    ...
    private void initView() {
        TextView textView = (TextView) findViewById(ResourceUtils.getIdByName(getContext(), "id", "sobot_tv_clear_his_msg_describe"));
        this.sobot_tv_clear_his_msg_describe = textView;
        textView.setText(ResourceUtils.getResString(getContext(), "sobot_clear_his_msg_describe"));
        ...
        button.setText(ResourceUtils.getResString(getContext(), "sobot_clear_his_msg_empty"));
