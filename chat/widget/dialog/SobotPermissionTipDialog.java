...
/* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/dialog/SobotPermissionTipDialog.class */
public class SobotPermissionTipDialog extends Dialog implements View.OnClickListener {
    ...
    /* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/dialog/SobotPermissionTipDialog$ClickViewListener.class */
    ...
    private void initView() {
        this.titleView = (TextView) findViewById(ResourceUtils.getIdByName(getContext(), "id", "sobot_dialog_title"));
        if (!TextUtils.isEmpty(this.title)) {
            TextView textView = this.titleView;
            textView.setText("\"" + CommonUtils.getAppName(getContext()) + "\" " + ResourceUtils.getResString(getContext(), "sobot_want_use_your") + this.title);
        }
        this.contentTV = (TextView) findViewById(ResourceUtils.getIdByName(getContext(), "id", "sobot_dialog_content"));
        ...
        button2.setText(ResourceUtils.getResString(getContext(), "sobot_btn_submit"));
