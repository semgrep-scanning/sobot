...
/* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/widget/image/SobotRCRelativeLayout.class */
public class SobotRCRelativeLayout extends RelativeLayout implements Checkable, RCAttrs {
    ...
    public SobotRCRelativeLayout(Context context, AttributeSet attributeSet, int i) {
