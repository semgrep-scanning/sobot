...
/* loaded from: source-8303388-dex2jar.jar:com/sobot/chat/viewHolder/RobotTemplateMessageHolder6.class */
public class RobotTemplateMessageHolder6 extends MessageHolderBase {
    ...
    public RobotTemplateMessageHolder6(Context context, View view) {
        super(context, view);
        this.sobot_template6_msg = (TextView) view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template6_msg"));
        this.sobot_template6_title = (TextView) view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template6_title"));
        ...
        this.sobot_template6_title.setMaxWidth(ScreenUtils.getScreenWidth((Activity) this.mContext) - ScreenUtils.dip2px(this.mContext, 102.0f));
        this.sobot_template6_msg.setMaxWidth(ScreenUtils.getScreenWidth((Activity) this.mContext) - ScreenUtils.dip2px(this.mContext, 102.0f));
    }
    ...
    private void setFailureView() {
        this.sobot_template6_msg.setVisibility(0);
        this.sobot_template6_title.setVisibility(8);
    }

    private void setSuccessView() {
        this.sobot_template6_msg.setVisibility(0);
        this.sobot_template6_title.setVisibility(0);
    }
    ...
    public void bindData(Context context, ZhiChiMessageBase zhiChiMessageBase) {
        ...
        if (zhiChiMessageBase.getAnswer() != null && zhiChiMessageBase.getAnswer().getMultiDiaRespInfo() != null) {
            ...
            HtmlTools.getInstance(context).setRichText(this.sobot_template6_msg, ChatUtils.getMultiMsgTitle(multiDiaRespInfo).replaceAll("\n", "<br/>"), getLinkTextColor());
            applyTextViewUIConfig(this.sobot_template6_msg);
            ...
            if (!"000000".equals(multiDiaRespInfo.getRetCode()) || interfaceRetList == null || interfaceRetList.size() <= 0) {
                ...
                if (map != null && map.size() > 0) {
                    ...
                    if (TextUtils.isEmpty(map.get("tempStr"))) {
                        ...
                        this.sobot_template6_title.setVisibility(0);
                        HtmlTools.getInstance(context).setRichText(this.sobot_template6_title, map.get("tempStr").replace("<div>", "").replace("</div>", "").replace("<p>", "").replace("</p>", "<br/>"), getLinkTextColor());
                    }
                }
            }
        }
    ...
    public void showRevaluateBtn() {
        ...
        this.sobot_tv_likeBtn.setSelected(false);
        this.sobot_tv_dislikeBtn.setSelected(false);
        this.sobot_tv_likeBtn.setOnClickListener(new NoDoubleClickListener() { // from class: com.sobot.chat.viewHolder.RobotTemplateMessageHolder6.2
            @Override // com.sobot.chat.listener.NoDoubleClickListener
            public void onNoDoubleClick(View view) {
                RobotTemplateMessageHolder6.this.doRevaluate(true);
            }
        });
        this.sobot_tv_dislikeBtn.setOnClickListener(new NoDoubleClickListener() { // from class: com.sobot.chat.viewHolder.RobotTemplateMessageHolder6.3
            @Override // com.sobot.chat.listener.NoDoubleClickListener
            public void onNoDoubleClick(View view) {
                RobotTemplateMessageHolder6.this.doRevaluate(false);
            }
        });
    }
    ...
    public void showTransferBtn() {
        ...
        this.sobot_ll_transferBtn.setOnClickListener(new NoDoubleClickListener() { // from class: com.sobot.chat.viewHolder.RobotTemplateMessageHolder6.1
            @Override // com.sobot.chat.listener.NoDoubleClickListener
            public void onNoDoubleClick(View view) {
                if (RobotTemplateMessageHolder6.this.msgCallBack != null) {
                    RobotTemplateMessageHolder6.this.msgCallBack.doClickTransferBtn(RobotTemplateMessageHolder6.this.message);
                }
            }
        });
    }
